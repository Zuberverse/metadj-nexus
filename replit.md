...
- **Wisdom Spotlight Layout**: Hub displays Featured content (static selection) above the Continue Reading section. Continue Reading dynamically shows the 3 most recently viewed wisdom items across all categories, updating as users explore content.
