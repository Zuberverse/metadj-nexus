...
- `use-audio-playback.ts` — Main orchestrating hook for playback lifecycle. Features a **playPromiseRef** mutex to prevent DOM racing and a **NotAllowedError** handler for mobile browser compatibility.
