...
- **Auto-open gating**: `STORAGE_KEYS.WELCOME_SHOWN` + a per-session flag (`metadj_welcome_shown_session`) keep it first-time-only by default (legacy override: `STORAGE_KEYS.WELCOME_DISMISSED`).
