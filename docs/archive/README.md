...
Only keep docs that remain useful as long‑term reference but are not actively maintained (e.g., a major migration rationale that still informs future work). Use date‑prefixed filenames for new additions.
