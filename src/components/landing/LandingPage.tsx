...
export function LandingPage() {
  ...
  return (
    <div className="min-h-[100svh] w-full text-white bg-[var(--bg-surface-base)] flex flex-col overflow-x-hidden">
      ...
      <footer className="relative z-20 mt-auto backdrop-blur-3xl">
        ...
        <div className="relative z-10 container mx-auto px-4 py-2 sm:px-6">
          <div className="flex items-center justify-center gap-x-1 font-heading font-bold">
            <Link
              href="/terms"
              className="min-h-[40px] px-2 inline-flex items-center justify-center text-xs text-purple-300/70 hover:text-purple-200 transition-colors cursor-pointer"
            >
              Terms
            </Link>
            <div className="flex items-center gap-2 border-l border-white/10 pl-3 ml-1 text-[10px]">
