                ...
                <div className="flex flex-col gap-2">
                  <div className="relative">
                    <input
                      ...
                      maxLength={100}
                      className={`w-full rounded-lg border bg-black/30 px-4 py-3 font-heading text-lg text-white placeholder-white/40 transition-colors focus:border-purple-neon focus-ring ${
