    ...
    <div ref={containerRef} className="relative">
      ...
      {isOpen && (
        <div
          ...
          className="absolute left-0 top-full mt-2 min-w-64 max-h-[60vh] overflow-y-auto overscroll-contain touch-pan-y rounded-2xl border border-(--border-elevated) bg-(--bg-surface-elevated)/95 backdrop-blur-xl shadow-[0_20px_60px_rgba(0,0,0,0.75)] z-10"
